...
export const APP_BASE_NAME = injectedDesktopAppBranding?.baseName ?? "Royal's Scriptorium";
export const APP_INSTALLATION_ID =
  injectedDesktopAppBranding?.installationId ?? "com.royalaid.scriptorium";
export const APP_UPSTREAM_REVISION = injectedDesktopAppBranding?.upstreamRevision ?? "untracked";
export const APP_SCRIPTORIUM_REVISION = injectedDesktopAppBranding?.scriptoriumRevision ?? "local";
export const APP_INCLUDED_CHANGES = injectedDesktopAppBranding?.changes ?? [];
