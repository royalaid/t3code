...
import Migration0041 from "./Migrations/041_GoalWorkflows.ts";
import Migration0042 from "./Migrations/042_SourceOwnedGoals.ts";
...
export const migrationEntries = [
  ...
  [41, "GoalWorkflows", Migration0041],
  [42, "SourceOwnedGoals", Migration0042],
] as const;
