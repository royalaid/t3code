...
import {
  ...
  type LaunchGoalInput,
  type PromoteQueuedRunInput,
  type ProvisionGoalSourceInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    launchGoal: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:goal:launch",
      execute: (input: LaunchGoalInput) => launchGoal(input),
      scheduler,
      concurrency,
    }),
    provisionGoalSource: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:goal:provision-source",
      execute: (input: ProvisionGoalSourceInput) => provisionGoalSource(input),
      scheduler,
      concurrency,
    }),
    ...
    reopenGoal: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:reopen-goal",
      execute: (input: ReopenGoalInput) => reopenGoal(input),
      scheduler,
      concurrency,
    }),
