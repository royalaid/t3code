...
export const GoalGraphVersionId = makeEntityId("GoalGraphVersionId");
export type GoalGraphVersionId = typeof GoalGraphVersionId.Type;
export const GoalNodeId = makeEntityId("GoalNodeId");
export type GoalNodeId = typeof GoalNodeId.Type;
export const GoalEdgeId = makeEntityId("GoalEdgeId");
export type GoalEdgeId = typeof GoalEdgeId.Type;
export const GoalAttemptId = makeEntityId("GoalAttemptId");
export type GoalAttemptId = typeof GoalAttemptId.Type;
export const GoalEvidenceId = makeEntityId("GoalEvidenceId");
export type GoalEvidenceId = typeof GoalEvidenceId.Type;
export const GoalArtifactId = makeEntityId("GoalArtifactId");
export type GoalArtifactId = typeof GoalArtifactId.Type;
